...
public class Admin extends AdminAbilities {
    ...
    @Override
    void slot(int slotno, String sport) {
    ...
    void showProfits() {
        ...
        try {
            ...
            if (ch == 1) {
                ...
                query = "select slotsbooking.slotno,slots.price from slotsbooking,slots where slotsbooking.slotno=slots.slotno and bookingdate=\""+date+"\";";
                rs = stmt.executeQuery(query);
