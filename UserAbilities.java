...
public interface UserAbilities {
    ...
    /*VIEW A BOOKING
        ...
        try
        {
            ...
            query="select orderno,Name,ContactNo,slots.slotno,sportname,startime,endtime,price from slots,slotsbooking where orderno="+orderno+" and Name=\""+bookname+"\" and slots.slotno=(select slotno from slotsbooking where orderno="+orderno+");";
            rs=stmt.executeQuery(query);
            while(rs.next())
            {
